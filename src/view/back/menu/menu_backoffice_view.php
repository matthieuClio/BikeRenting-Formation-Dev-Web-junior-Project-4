...
<nav class="menu_backoffice">
	<ul class="contain_menu_backoffice">
		...
		<li class="tab_backoffice">
			<img src="public/images/icone/ticket.png" alt="Icone Billets" class="logo_tab_backoffice">
			<a href="backoffice/billets" class="text_tab_backoffice">Billets</a>
		</li>
...
<!-- Menu Mobile -->
<nav class="menu_backoffice_mobile">
	<ul class="contain_menu_backoffice_mobile">
		...
		<li>
			<a href="backoffice/billets" class="text_tab_backoffice">
				<img src="public/images/icone/ticket.png" alt="Icone Billets" class="logo_tab_backoffice">
			</a>
		</li>
